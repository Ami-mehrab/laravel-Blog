			  ...
			  <li class="nav-item dropdown">
			   ...
			   <li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="dropdown05">
						<li><a class="dropdown-item" href="https://themewagon.github.io/megakit-2/blog-grid.html">Blog Grid</a></li>
						<li><a class="dropdown-item" href="https://themewagon.github.io/megakit-2/blog-sidebar.html">Blog with Sidebar</a></li>

						<li><a class="dropdown-item" href="https://themewagon.github.io/megakit-2/blog-single.html">Blog Single</a></li>
					</ul>
			  </li>
